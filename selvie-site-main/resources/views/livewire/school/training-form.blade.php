        ...
        <x-slot name="content">
            <div class="space-y-6">
                ...
                <div>
                    ...
                    <select id="level" wire:model.defer="state.level" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary focus:ring-primary sm:text-sm">
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3 text-sm">
                        <label for="is_required" class="font-medium text-gray-700">Required Training</label>
                        <p class="text-gray-500">Mark this training as required for all team members</p>
                    </div>
                </div>
